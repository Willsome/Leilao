...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private List<Leilao> leiloesDeExemplo() {
        ...
        console.propoe(new Lance(new Usuario("Usuário 1"), 300.0));
        console.propoe(new Lance(new Usuario("Usuário 2"), 200.0));
        console.propoe(new Lance(new Usuario("Usuário 2"), 2050.0));
        console.propoe(new Lance(new Usuario("Usuário 2"), 200.0));
